Shader "Holistic/RayMarchCloudsVolume"
{
    Properties
    {
        ...
        _StepScale ("StepScale", Range (0.1, 100.0)) = 1
        _Steps ("Steps", Range(1,200)) = 60
        _MinHeight ("Min Height", Range (0.0, 5.0)) = 0
        _MaxHeight ("Max Height", Range (6, 10.0)) = 10
        _FadeDist ("Fade Distance", Range (0, 10.0)) = 0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                return float3( random(value, float3(12.898, 68.54, 37.7298)), random(value, float3(39.898, 26.54, 85.7238)), random(value, float3(76.898, 12.54, 8.6788)));
            }
